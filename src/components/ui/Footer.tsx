...
function Footer(props: FooterProps) {
    ...
    return (<footer className={`flex flex-col flex-center py-[48px] min-w-[375px] w-full h-[375px] xs:h-[262px] bg-white ${(className)? className:''}`} style={{...style}}>
        <img src='logo-sm.svg' className='object-cover w-[300px] h-[38px] 2xs:w-[200px] 2xs:h-[26px]' alt='jouney bites' />
        <div className='bg-curveline bg-cover w-[67px] h-[5px] mt-[20px]' />
